...
export function ProjectCard({
  ...
  return (
    <Link href={`/portfolio/${project.slug}`} className="content-auto group block">
      ...
      <div className="mt-5 flex items-start justify-between gap-4 border-t border-[#d9d9d9] pt-4">
        <div>
        ...
        <div className="text-right text-xs font-bold uppercase leading-5 text-[#777777]">
